...
- [x] All icons come from a consistent icon family and style
- [x] Official brand assets are used with correct proportions and clear space
- [ ] Pressed-state visuals do not shift layout bounds or cause jitter
- [ ] Semantic theme tokens are used consistently (no ad-hoc per-screen hardcoded colors)

### Interaction

- [x] All tappable elements provide clear pressed feedback (ripple/opacity/elevation)
- [x] Touch targets meet minimum size (>=44x44pt iOS, >=48x48dp Android)
- [x] Micro-interaction timing stays in the 150-300ms range with native-feeling easing
...
- [x] Safe areas are respected for headers, tab bars, and bottom CTA bars
- [ ] Scroll content is not hidden behind fixed/sticky bars
- [x] Verified on small phone, large phone, and tablet (portrait + landscape)
- [x] Horizontal insets/gutters adapt correctly by device size and orientation
- [ ] 4/8dp spacing rhythm is maintained across component, section, and page levels
- [ ] Long-form text measure remains readable on larger devices (no edge-to-edge paragraphs)

### Accessibility

- [x] All meaningful images/icons have accessibility labels
- [x] Form fields have labels, hints, and clear error messages

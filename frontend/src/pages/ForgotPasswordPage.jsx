...
export default function ForgotPasswordPage() {
      ...
      const handleResend = async () => {
            ...
            try {
                  ...
                  setMessage(
                        "Nouveau code envoye. Verifiez vos notifications.",
                  );
                              ...
                              <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 py-10">
                                    ...
                                    {step === "email" ? (
                                          ...
                                          <>
                                                ...
                                                >
                                                      <div>
                                                            <label className="text-xs font-bold text-gray-500 mb-3 block uppercase tracking-wide">
                                                                  Code de
                                                                  verification
                                                            </label>
                                                            <div

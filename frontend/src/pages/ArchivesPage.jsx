        ...
        <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto custom-scrollbar">
          <div className={`max-w-6xl mx-auto transition-all duration-500 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-navy">Archives de cours</h1>
                <p className="text-sm text-gray-400 mt-0.5">Accédez aux supports pédagogiques par UE</p>
              </div>
            </div>
            <ArchiveGrid />
          </div>

...
export default function UserProfilePage() {
      ...
      useEffect(() => {
            ...
            setLoading(true);
            setError("");
            api.get(`/auth/user/${ref.toUpperCase()}`)
                  .then(({ data }) => {
                        setProfile(data);
                  })
                  .catch((err) => {
                  ...
                  <div className="flex h-screen bg-surface overflow-hidden">
                        ...
                        <div className="flex-1 flex flex-col overflow-hidden">
                              ...
                              <main className="flex-1 flex items-center justify-center">
                                    <FontAwesomeIcon
                                          icon={faSpinner}
                                          className="text-gold text-3xl animate-spin"
                                    />
                              </main>
                        </div>
                  </div>
      ...
      const handlePing = async () => {
            if (isOwnProfile) {
                  setPingState("self");
                  setPingMsg(
                        "Vous ne pouvez pas vous envoyer un ping à vous-même.",
                  );
                  return;
            }
            ...
            <div className="flex h-screen bg-surface overflow-hidden">
                  ...
                  <div className="flex-1 flex flex-col overflow-hidden">
                        ...
                        <main className="flex-1 overflow-y-auto relative">
                              <div className="max-w-2xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-40">
                                    ...
                                    >
                                          <div
                                                ...
                                                style={{
                                                      ...
                                                      boxShadow:
                                                            "0 8px 32px rgba(0,0,0,0.3), 0 0 40px rgba(212,175,55,0.08), inset 0 1px 0 rgba(255,255,255,0.05)",
                                                }}
                                          >
                                                {/* Cover area */}
                                                ...
                                                {/* Avatar + info */}
                                                <div className="px-6 pb-6 -mt-12 relative z-40">

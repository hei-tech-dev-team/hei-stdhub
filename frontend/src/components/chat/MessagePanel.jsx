    ...
    <div className={`flex flex-col ${isOwn ? "items-end" : "items-start"}`}>
      {messages.map((msg, idx) => {
        ...
        if (isFileMessage(msg.content)) {
          return (
            <div key={msg.id} className="flex items-end gap-2 mb-1.5 max-w-[90%] sm:max-w-[75%] min-w-0">
              {!isOwn && isFirst && (
        ...
        return (
          <div
            key={msg.id}
            className={`group relative flex items-end gap-2 mb-1 max-w-[90%] sm:max-w-[75%] min-w-0 ${
  ...
  return (
    <div className="flex flex-col h-full min-w-0">
      ...
      <div
        ...
        className="flex-1 overflow-y-auto overflow-x-hidden px-2 sm:px-6 py-4 sm:py-6 flex flex-col relative"
      >
        {loading && (
      ...
      {/* Input */}
      <div className="px-2 sm:px-6 py-3 sm:py-5 bg-white/5 backdrop-blur-xl border-t border-white/10 shrink-0">

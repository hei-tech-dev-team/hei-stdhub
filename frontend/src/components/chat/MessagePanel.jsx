...
export default function MessagePanel({
    ...
    if (contact.isGlobal) {
      return (
        <div className="w-9 h-9 rounded-full bg-white/10 border border-white/20
          ...
          <img src={HEI_WHITE_LOGO} alt="HEI" className="w-5 h-5 object-cover" />
        </div>
      );
    }
    if (contact.avatar) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0f1e33]">
      ...
      <div ref={scrollRef} onScroll={handleScroll}
        ...
        {!loading && messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full gap-3 opacity-30">
            <img src={HEI_WHITE_LOGO} alt="HEI"
            ...
            {!msg.own && (
              msg.senderAvatar ? (
                <div className="w-7 h-7 rounded-full overflow-hidden shrink-0">
                  <img src={msg.senderAvatar} alt={msg.sender}
                       className="w-full h-full object-cover" />
                </div>
              ) : (
      ...
      {/* Zone saisie */}
      <div className="px-3 sm:px-4 py-3 bg-[#1a2b45]
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 flex items-center bg-white/10 rounded-2xl

...
CREATE TABLE users (
  ...
  profile_background TEXT NULL,
  cover_border_color VARCHAR(32) NULL,
  avatar_border_color VARCHAR(32) NULL,
  cover_parallax BOOLEAN  NOT NULL DEFAULT TRUE,
  welcome_message_theme VARCHAR(50) NOT NULL DEFAULT 'simple',
  welcome_message_enabled BOOLEAN NOT NULL DEFAULT FALSE,
  welcome_bubble_url TEXT NULL,
